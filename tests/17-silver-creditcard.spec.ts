...
// GRAM KÜLÇE GÜMÜŞ ürünü sepete eklenir.
// Ödeme yöntemi olarak Banka / Kredi Kartı seçilir.
// Kayıtlı kart seçilir.
// Ön bilgilendirme formu onaylanır.
// 3D Secure OTP girilir.
// =============================================================================
...
test("Kullanıcı yolculuğu - Kredi Kartı ile Ödeme", async ({ page }) => {
  ...
  await test.step("3. Kategori menüsünü kontrol et", async () => {
    ...
    await expect(gumusLink).toBeVisible({ timeout: 15_000 });

    console.log("✓ GRAM KÜLÇE GÜMÜŞ kategori menüsü görünüyor");
  });
